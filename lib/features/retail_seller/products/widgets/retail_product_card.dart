...
class RetailProductCard extends StatelessWidget {
  final RetailProduct product; // 👈 Updated model
  const RetailProductCard({super.key, required this.product});
      ...
      child: InkWell(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => ViewRetailProduct( // 👈 Navigate to retail page
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    // Product Name
                    Text(
                      product.name, // 👈 Use RetailProduct field
                      maxLines: 1,
