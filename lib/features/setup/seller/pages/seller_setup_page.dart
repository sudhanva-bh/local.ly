import 'dart:ui'; // 1. Add this import for ImageFilter
...
import 'package:locally/features/setup/seller/widgets/personal_details.dart';

class SellerSetupPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SellerSetupPage> createState() => _SellerSetupPageState();
}

class _SellerSetupPageState extends ConsumerState<SellerSetupPage> {
  ...
  Future<void> _completeSetup() async {
    ...
    try {
      ...
      String? fcmToken;
      try {
        // This triggers the OS permission dialog if not already granted
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    8.heightBox,
                    Text(
                      "Enter the details below to set up your ${widget.accountType.toWords().toLowerCase()} profile.",
                      textAlign: TextAlign.center,
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              'By tapping "Finish Setup", you agree to receive notifications about orders and messages.',
